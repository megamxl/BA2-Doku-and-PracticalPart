...
func Handle(w http.ResponseWriter, r *http.Request) {
	...
	connStr := "postgresql://exampleuser:examplepass@192.168.178.109:5432/exampledb?sslmode=disable"
...
func selectByID(db sql.DB, red redis.Client, w http.ResponseWriter, r *http.Request) {
	...
	bytes, err := red.Get(context.TODO(), trackingNumber).Result()
	if err == nil {
	...
	err = red.Set(context.TODO(), parcel.TrackingNumber, responseBytes, 0).Err()
	if err != nil {
...
func updateById(db sql.DB, red redis.Client, w http.ResponseWriter, r *http.Request) {
	...
	err = red.Set(context.TODO(), reqBody.TrackingNumber, responseBytes, 0).Err()
	if err != nil {
		w.Header().Set("Failure", "Redis")
	}
...
func createPackage(db sql.DB, red redis.Client, w http.ResponseWriter, r *http.Request) {
	...
	err = red.Set(context.TODO(), gen_trackingNumber, jsonData, 0).Err()
	if err != nil {
		w.Header().Set("Failure", "Redis")
	}
